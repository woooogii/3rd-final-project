        ...
        <StyledTickets>
            ...
            {tCategory && (
                <div>
                    ...
                    <div className="card-container">
                        <div className="card text-end" id="credit" style={{ width: '220px', height: '90px',}}>
                    ...
                    <div className="card-container">
                        <div className="card text-end" id="kakao" style={{ width: '220px', height: '90px'}}>
                                <input type="radio" name="payment" value="kakaopay" onChange={handleModule} />
                            <div className="cards" style={{ display: 'flex', justifyContent: 'center', marginTop: '10px' }}>
                                <img src="/image/kakaopay.png" alt="kakaopay" style={{ width: '65px', height: '25px', position: 'relative', marginLeft: '5px', marginTop: '18px'}} />
